...
export const games: Game[] = [
  ...
  },
  {
    ...
    finalTurn: 5,
    turnScores: [
      { turn: 1, player1Points: 18, player2Points: 12 },
      { turn: 2, player1Points: 36, player2Points: 26 },
      { turn: 3, player1Points: 54, player2Points: 40 },
      { turn: 4, player1Points: 70, player2Points: 52 },
      { turn: 5, player1Points: 86, player2Points: 63 },
    ],
  },
  {
    id: 23,
    ...
    finalTurn: 5,
    turnScores: [
      { turn: 1, player1Points: 14, player2Points: 20 },
      { turn: 2, player1Points: 28, player2Points: 38 },
      { turn: 3, player1Points: 42, player2Points: 56 },
      { turn: 4, player1Points: 54, player2Points: 72 },
      { turn: 5, player1Points: 66, player2Points: 88 },
    ],
  },
  {
    id: 24,
    ...
    turnScores: [
      { turn: 1, player1Points: 12, player2Points: 18 },
      { turn: 2, player1Points: 26, player2Points: 36 },
      { turn: 3, player1Points: 40, player2Points: 52 },
      { turn: 4, player1Points: 52, player2Points: 68 },
      { turn: 5, player1Points: 64, player2Points: 82 },
    ],
  },
  {
    id: 25,
    ...
    finalTurn: 5,
    turnScores: [
      { turn: 1, player1Points: 22, player2Points: 16 },
      { turn: 2, player1Points: 42, player2Points: 30 },
      { turn: 3, player1Points: 60, player2Points: 44 },
      { turn: 4, player1Points: 76, player2Points: 56 },
      { turn: 5, player1Points: 90, player2Points: 68 },
    ],
  },
  {
    id: 26,
    player1: "Jaedon Nixon",
    ...
    finalTurn: 5,
    turnScores: [
      { turn: 1, player1Points: 10, player2Points: 16 },
      { turn: 2, player1Points: 22, player2Points: 34 },
      { turn: 3, player1Points: 36, player2Points: 52 },
      { turn: 4, player1Points: 48, player2Points: 70 },
      { turn: 5, player1Points: 60, player2Points: 87 },
    ],
  },
  {
    id: 27,
    player1: "Aaron Dewapenaere",
    player1Army: "Emperor's Children",
    player2: "Jaedon Nixon",
    player2Army: "Black Templars",
    winner: "player1",
    date: "2026-03-20",
    ...
    turnScores: [
      { turn: 1, player1Points: 18, player2Points: 10 },
      { turn: 2, player1Points: 36, player2Points: 24 },
      { turn: 3, player1Points: 54, player2Points: 38 },
      { turn: 4, player1Points: 72, player2Points: 50 },
      { turn: 5, player1Points: 88, player2Points: 62 },
    ],
  },
  {
    id: 28,
    ...
    turnScores: [
      { turn: 1, player1Points: 14, player2Points: 20 },
      { turn: 2, player1Points: 28, player2Points: 40 },
      { turn: 3, player1Points: 44, player2Points: 58 },
      { turn: 4, player1Points: 56, player2Points: 74 },
      { turn: 5, player1Points: 68, player2Points: 90 },
    ],
  },
  {
    id: 29,
    ...
    turnScores: [
      { turn: 1, player1Points: 20, player2Points: 14 },
      { turn: 2, player1Points: 40, player2Points: 30 },
      { turn: 3, player1Points: 58, player2Points: 46 },
      { turn: 4, player1Points: 76, player2Points: 58 },
      { turn: 5, player1Points: 92, player2Points: 70 },
    ],
  },
];
